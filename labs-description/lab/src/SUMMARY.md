...
- [Процессы](3-user-0-intro.md)
  - [Загрузка процесса в память](3-user-1-elf.md)
  - [Проверки доступа процесса к памяти](3-user-2-permission-checks.md)
  - [Переход в режим пользователя](3-user-3-user-mode.md)
  - [Поддержка системных вызовов](3-user-4-syscall.md)
